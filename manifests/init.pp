...
class postfix (
  ...
  $main_default_process_limit              = 100,
  $main_qmgr_message_active_limit          = 20000,
  $main_qmgr_message_recipient_limit       = 20000,
  $main_default_destination_concurrency_limit  = 20,
  $main_default_destination_recipient_limit    = 50,
  ...
  validate_bool($main_use_relayhost)
